    ...
    <div class="position-header flex-ja-center" ref="tab-box">
      ...
      >
        <div class="align-center">
          <span>在招中</span>
          <span class="fs-12 pl-10">3</span>
        </div>
        <div v-show="tabFlag" class="bottom-line"></div>
      </div>
      <div
        class="head-nav flex-ja-center cur-po"
      ...
      <div class="tab1" v-show="currentIndex== 0">
        <div class="job wrap">
          <div class="job-head just-between">
            ...
            <div>
              <div class="release-btn cur-po">+ 发布职位</div>
            </div>
          </div>
          <div class="job-box mb-15">
            <div class="info-job just-between">
              ...
              <div class="refresh-info flex">
                <div class="refresh-btn cur-po">自动刷新</div>
                <div class="autorefresh-btn">
                  <span class="plr-5 cur-po">刷新</span>
                </div>
              </div>
            </div>
  ...
  .job-box {
    ...
    .info-job {
      ...
      .info-list {
        ...
        .bor {
          height: 12px;
          border-left: 1px solid rgb(197, 200, 206);
          margin: 0 10px;
        }
      }
      .resume-info {
